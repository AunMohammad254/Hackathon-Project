            ...
            <div className="p-8 relative z-10">
                ...
                {aiLoading ? (
                    <div className="flex flex-col items-center justify-center py-12 space-y-4 text-indigo-200">
                        ...
                        <p className="font-medium animate-pulse">Analyzing recent clinic data with Gemini AI...</p>
                    </div>
                ) : aiData ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="bg-emerald-500/10 backdrop-blur-sm border border-emerald-500/20 rounded-xl p-5 hover:bg-emerald-500/15 transition-colors">
                            ...
                            <p className="text-slate-100 text-sm leading-relaxed mb-3"><strong>Insight:</strong> {aiData.trendInsight}</p>
